...
| # | 任务 | 优先级 | 预计工时 |
|---|------|--------|----------|
| 1 | uni-app H5 适配验证 | P1 | 0.5h |
| 2 | 清理训练中间文件 | P1 | 0.5h |
| 3 | Nginx + HTTPS（可选，仅公网部署） | P2 | 1h |

```bash
# 1. H5 验证
cd Service-Outsourcing/frontend/front && npm run dev:h5
...
| # | 任务 | 优先级 | 预计工时 |
|---|------|--------|----------|
| 1 | 系统架构图（draw.io/Mermaid） | P0 | 1h |
| 2 | 知识蒸馏技术方案文档 | P0 | 2h |
| 3 | 系统演示视频 | P0 | 2h |
| 4 | 答辩 PPT（15-20页） | P0 | 3h |
| 5 | 项目 README | P1 | 1h |
